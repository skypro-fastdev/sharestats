...
(function (factory) {
    ...
    var factoryOutput = (() => {
        ...
        var H = (l, t) => {
            ...
            if (t && typeof t == "object" || typeof t == "function") for (let n of x(t)) !P.call(l, n) && n !== e && I(l, n, {
                get: () => t[n],
        ...
        var z = 0, N = {
            ...
            F = ["800", "822", "833", "844", "855", "866", "877", "880", "881", "882", "883", "884", "885", "886", "887", "888", "889"],
            v = l => l.replace(/\D/g, ""),
            A = (l = "") => l.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), k = l => {
                let t = v(l);
                if (t.charAt(0) === "1") {
                    let e = t.substr(1, 3);
                ...
                constructor(t, e = {}) {
                    this.id = z++, this.a = t, this.c = null, this.d = Object.assign({}, N, e), this.e = !!t.getAttribute("placeholder")
                }

                _init() {
                    this.d.useFullscreenPopup && (this.d.fixDropdownWidth = !1), this.d.separateDialCode && (this.d.allowDropdown = !0, this.d.nationalMode = !1, this.d.countrySearch = !0), !this.d.showFlags && !this.d.separateDialCode && (this.d.nationalMode = !1), this.d.useFullscreenPopup && !this.d.dropdownContainer && (this.d.dropdownContainer = document.body), this.isAndroid = typeof navigator < "u" ? /Android/i.test(navigator.userAgent) : !1, this.isRTL = !!this.a.closest("[dir=rtl]"), this.d.separateDialCode && (this.isRTL ? this.originalPaddingRight = this.a.style.paddingRight : this.originalPaddingLeft = this.a.style.paddingLeft), this.d.i18n = {...w, ...this.d.i18n};
                ...
                _sortCountries() {
                    this.d.countryOrder && (this.d.countryOrder = this.d.countryOrder.map(t => t.toLowerCase())), this.p.sort((t, e) => {
                        ...
                        if (i) {
                            let n = i.indexOf(t.iso2), s = i.indexOf(e.iso2), o = n > -1, r = s > -1;
                ...
                _f() {
                    ...
                    t && (d += " iti--allow-dropdown"), i && (d += " iti--show-flags"), n && (d += ` ${n}`), u || (d += " iti--inline-dropdown");
                    let p = c("div", {class: d});
                    if (this.a.parentNode?.insertBefore(p, this.a), t || i) {
                        this.k = c("div", {class: "iti__country-container"}, p), t ? (this.selectedCountry = c("button", {
                            type: "button",
                            ...
                            role: "combobox"
                        }, this.k), this.a.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = c("div", {class: "iti__selected-country"}, this.k);
                        let m = c("div", {class: "iti__selected-country-primary"}, this.selectedCountry);
                        if (this.l = c("div", null, m), this.selectedCountryA11yText = c("span", {class: "iti__a11y-text"}, this.l), t && (this.u = c("div", {
                            class: "iti__arrow",
                            "aria-hidden": "true"
                        }, m)), e && (this.t = c("div", {class: "iti__selected-dial-code"}, this.selectedCountry)), t) {
                            let y = r ? "" : "iti--flexible-dropdown-width";
                            if (this.dropdownContent = c("div", {
                                id: `iti-${this.id}__dropdown-content`,
                                class: `iti__dropdown-content iti__hide ${y}`
                            }), h && (this.searchInput = c("input", {
                                type: "text",
                                ...
                                autocomplete: "off"
                            }, this.dropdownContent), this.searchResultsA11yText = c("span", {class: "iti__a11y-text"}, this.dropdownContent)), this.countryList = c("ul", {
                                ...
                                u ? C += " iti--fullscreen-popup" : C += " iti--inline-dropdown", this.dropdown = c("div", {class: C}), this.dropdown.appendChild(this.dropdownContent)
                            } else this.k.appendChild(this.dropdownContent)
                        }
                    }
                    if (p.appendChild(this.a), s) {
                        let m = this.a.getAttribute("name") || "", y = s(m);
                        y.phone && (this.hiddenInput = c("input", {
                            type: "hidden",
                            name: y.phone
                        }), p.appendChild(this.hiddenInput)), y.country && (this.hiddenInputCountry = c("input", {
                            type: "hidden",
                            name: y.country
                ...
                _g() {
                    for (let t = 0; t < this.p.length; t++) {
                        let e = this.p[t], i = t === 0 ? "iti__highlight" : "", n = c("li", {
                        ...
                        let s = "";
                        this.d.showFlags && (s += `<div class='iti__flag-box'><div class='iti__flag iti__${e.iso2}'></div></div>`), s += `<span class='iti__country-name'>${e.name}</span>`, s += `<span class='iti__dial-code'>+${e.dialCode}</span>`, n.insertAdjacentHTML("beforeend", s)
                    }
                }

                _h(t = !1) {
                    let e = this.a.getAttribute("value"), i = this.a.value,
                        s = e && e.charAt(0) === "+" && (!i || i.charAt(0) !== "+") ? e : i, o = this._5(s),
                        r = k(s), {initialCountry: u, geoIpLookup: h} = this.d, g = u === "auto" && h;
                    if (o && !r) this._v(s); else if (!g || t) {
                ...
                _i3() {
                    ...
                    t && !a.utils ? a.documentReady() ? a.loadUtils(t) : window.addEventListener("load", () => {
                        a.loadUtils(t)
                    }) : this.i0(), e === "auto" && i && !this.s.iso2 ? this._i4() : this.h()
                }

                _i4() {
                    a.autoCountry ? this.handleAutoCountry() : a.startedLoadingAutoCountry || (a.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                        e && this._y(e, !0) ? (a.autoCountry = e, setTimeout(() => b("handleAutoCountry"))) : (this._h(!0), b("rejectAutoCountryPromise"))
                    }, () => {
                ...
                _j() {
                    let {strictMode: t, formatAsYouType: e, separateDialCode: i, formatOnDisplay: n} = this.d, s = !1,
                        o = () => {
                            this._n(), this.searchInput.value = "+", this._p3("", !0)
                        };
                    this._a12 = r => {
                        if (this.isAndroid && r?.data === "+" && i) {
                            let d = this.a.selectionStart || 0, p = this.a.value.substring(0, d - 1),
                                m = this.a.value.substring(d);
                            this.a.value = p + m, o();
                            return
                        }
                        this._v(this.a.value) && this._8();
                        let u = r?.data && /[^+0-9]/.test(r.data), h = r?.inputType === "insertFromPaste" && this.a.value;
                        ...
                        if (e && !s && !g) {
                            let d = this.a.selectionStart || 0,
                                ...
                                y = r?.inputType === "deleteContentForward", C = this._9(), L = j(m, C, d, y);
                            this.a.value = C, this.a.setSelectionRange(L, L)
                        }
                    }, this.a.addEventListener("input", this._a12), (t || i) && (this._handleKeydownEvent = r => {
                        if (r.key && r.key.length === 1 && !r.altKey && !r.ctrlKey && !r.metaKey) {
                            ...
                            if (t) {
                                let u = this.a.selectionStart === 0 && r.key === "+", h = /^[0-9]$/.test(r.key), g = u || h,
                                    d = this._6(), p = a.utils.getCoreNumber(d, this.s.iso2),
                                    m = this.maxCoreNumberLength && p.length >= this.maxCoreNumberLength,
                                    y = this.a.value.substring(this.a.selectionStart, this.a.selectionEnd),
                                    C = /\d/.test(y);
                                (!g || m && !C) && r.preventDefault()
                            }
                        }
                ...
                _o() {
                    if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown), !this.d.useFullscreenPopup) {
                        let t = this.a.getBoundingClientRect(), e = this.a.offsetHeight;
                ...
                _p3(t, e = !1) {
                    ...
                    for (let s = 0; s < this.p.length; s++) {
                        let o = this.p[s], r = A(o.name), u = `+${o.dialCode}`;
                ...
                _v(t) {
                    let e = t.indexOf("+"), i = e ? t.substring(e) : t, n = this.s.dialCode;
                    i && n === "1" && i.charAt(0) !== "+" && (i.charAt(0) !== "1" && (i = `1${i}`), i = `+${i}`), this.d.separateDialCode && n && i.charAt(0) !== "+" && (i = `+${n}${i}`);
                    let o = this._5(i, !0), r = v(i), u = null;
                    if (o) {
                        let h = this.q[v(o)], g = h.indexOf(this.s.iso2) !== -1 && r.length <= o.length - 1;
                        if (!(n === "1" && k(r)) && !g) {
                            for (let p = 0; p < h.length; p++) if (h[p]) {
                                u = h[p];
                                break
                            }
                        }
                    } else i.charAt(0) === "+" && r.length ? u = "" : (!i || i === "+") && !this.s.iso2 && (u = this.j);
                ...
                _z(t) {
                    let {separateDialCode: e, showFlags: i, i18n: n} = this.d, s = this.s.iso2 ? this.s : {};
                    if (this.s = t ? this._y(t, !1) || {} : {}, this.s.iso2 && (this.j = this.s.iso2), this.l) {
                        let o = "", r = "";
                        t && i ? (o = `iti__flag iti__${t}`, r = `${this.s.name} +${this.s.dialCode}`) : (o = "iti__flag iti__globe", r = n.noCountrySelected), this.l.className = o, this.selectedCountryA11yText.textContent = r
                    }
                    if (this._z3(t, e), e) {
                        let o = this.s.dialCode ? `+${this.s.dialCode}` : "";
                        this.t.innerHTML = o;
                        let u = (this.selectedCountry.offsetWidth || this._z2()) + 8;
                        this.isRTL ? this.a.style.paddingRight = `${u}px` : this.a.style.paddingLeft = `${u}px`
                    }
                ...
                _updateMaxLength() {
                    ...
                    if (t && a.utils) if (this.s.iso2) {
                        let n = a.utils.numberType[e], s = a.utils.getExampleNumber(this.s.iso2, !1, n, !0), o = s;
                ...
                _0() {
                    ...
                    if (a.utils && s) {
                        let o = a.utils.numberType[e], r = this.s.iso2 ? a.utils.getExampleNumber(this.s.iso2, i, o) : "";
                        r = this._7(r), typeof n == "function" && (r = n(r, this.s)), this.a.setAttribute("placeholder", r)
                    }
                }
                ...
                _3(t) {
                    let e = this.countryList, i = document.documentElement.scrollTop, n = e.offsetHeight,
                        s = e.getBoundingClientRect().top + i, o = s + n, r = t.offsetHeight,
                        u = t.getBoundingClientRect().top + i, h = u + r, g = u - s + e.scrollTop;
                    if (u < s) e.scrollTop = g; else if (h > o) {
                        let d = n - r;
                        e.scrollTop = g - d
                    }
                }
                    ...
                    if (t.charAt(0) === "+") {
                        ...
                        for (let s = 0; s < t.length; s++) {
                            ...
                            if (!isNaN(parseInt(o, 10))) {
                                if (n += o, e) this.q[n] && (i = t.substr(0, s + 1)); else if (this.dialCodes[n]) {
                                    i = t.substr(0, s + 1);
                                    break
                                }
                ...
                _6() {
                    let t = this.a.value.trim(), {dialCode: e} = this.s, i, n = v(t);
                    return this.d.separateDialCode && t.charAt(0) !== "+" && e && n ? i = `+${e}` : i = "", i + t
                }
                ...
                _9() {
                    let t = this._6(),
                        e = a.utils ? a.utils.formatNumberAsYouType(t, this.s.iso2) : t, {dialCode: i} = this.s;
                    return this.d.separateDialCode && this.a.value.charAt(0) !== "+" && e.includes(`+${i}`) ? (e.split(`+${i}`)[1] || "").trim() : e
                }

                handleAutoCountry() {
                    this.d.initialCountry === "auto" && a.autoCountry && (this.j = a.autoCountry, this.s.iso2 || this.l.classList.contains("iti__globe") || this.setCountry(this.j), this.h())
                }

                handleUtils() {
                    a.utils && (this.a.value && this._u(this.a.value), this.s.iso2 && (this._0(), this._updateMaxLength())), this.i0()
                }
                ...
                destroy() {
                    ...
                    n?.parentNode?.insertBefore(this.a, n), n?.parentNode?.removeChild(n), delete a.instances[this.id]
                }
                ...
                isValidNumber() {
                    let t = this._6();
                    return /\p{L}/u.test(t) ? !1 : a.utils ? a.utils.isPossibleNumber(t, this.s.iso2, this.d.validationNumberType) : null
                }

                isValidNumberPrecise() {
                    let t = this._6();
                    return /\p{L}/u.test(t) ? !1 : a.utils ? a.utils.isValidNumber(t, this.s.iso2) : null
                }

                setCountry(t) {
                    let e = t?.toLowerCase(), i = this.s.iso2;
            ...
            B = l => !a.utils && !a.startedLoadingUtilsScript ? (a.startedLoadingUtilsScript = !0, new Promise((t, e) => {
                import(/* webpackIgnore: true */ l).then(({default: i}) => {
                    a.utils = i, b("handleUtils"), t(!0)
                }).catch(() => {
                    b("rejectUtilsScriptPromise"), e()
                })
            })) : null, a = Object.assign((l, t) => {
                let e = new _(l, t);
                return e._init(), l.setAttribute("data-intl-tel-input-id", e.id.toString()), a.instances[e.id] = e, e
            }, {
                defaults: N,
